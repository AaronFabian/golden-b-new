          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navigation">
              <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                  <a class="nav-link me-2" href="?menu=register">
              ...
              <ul class="navbar-nav d-lg-block d-none">
                <li class="nav-item">
                  <a href="?menu=webpage" class="btn btn-sm mb-0 me-1 btn-primary">Kembali ke webpage</a>
                </li>
              </ul>
            </div>
          </div>
                ...
                <div class="card card-plain">
                  ...
                  <div class="card-body">
                    <form role="form" method="POST" action="">
                      ...
                      <div class="text-center">
                        <button type="submit" class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0" name="btnSignin">Log In</button>
                      </div>
                    </form>
                  </div>
                  <div class="card-footer text-center pt-0 px-lg-2 px-1">
                    <p class="mb-4 text-sm mx-auto">
                      Belum punya akun ?
                      <a href="?menu=register" class="text-primary text-gradient font-weight-bold">Daftar sekarang</a>
                    </p>
                  </div>
                </div>
              </div>
