    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        ...
        <ul class="navbar-nav d-lg-block d-none">
          <li class="nav-item">
            <a href="?menu=webpage" class="btn btn-sm mb-0 me-1 bg-gradient-light">Kembali ke webpage</a>
          </li>
        </ul>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Silahkan masukkan data diri untuk membuat akun baru</p>
          </div>
        </div>
      </div>
    </div>
            ...
            <div class="card-body">
              <form role="form" method="POST" enctype="multipart/form-data">
                <div class="row">
                  <div class="col">
                    <div class="mb-3">
                      <input type="text" class="form-control" placeholder="Nama depan" aria-label="Nama depan" name="firstName">
                    </div>
                  </div>
                  <div class="col">
                    <div class="mb-3">
                      <input type="text" class="form-control" placeholder="Nama belakang" aria-label="Nama belakang" name="lastName">
                    </div>
                  </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <input type="password" class="form-control" placeholder="konfirmasi password" aria-label="konfirmasi password" name="password2">
                </div>
                <div class="mb-3">
                  <input type="Nik" class="form-control" placeholder="Nik" aria-label="Nik" name="nik">
                </div>
                <select class="form-select mb-3" aria-label="Default select example" name="adminSection">
                  <option selected value="">Pilih Bagian</option>
                  <option value="Golden B buah batu">Golden B buah batu</option>
                  <option value="Cimekar Cinunuk">Cimekar Cinunuk</option>
                </select>
                <div class="form-check form-check-info text-start">
                  <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" checked name="agreeBtn">
                  <label class="form-check-label" for="flexCheckDefault">
                    Saya setuju dengan <a href="javascript:;" class="text-dark font-weight-bolder">Syarat dan Ketentuan</a>
                  </label>
                </div>
                <div class="text-center">
                  <button type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2" name="btnRegister">Daftar</button>
                </div>
